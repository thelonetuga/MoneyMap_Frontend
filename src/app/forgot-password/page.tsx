    ...
    <main className="min-h-screen flex items-center justify-center bg-secondary dark:bg-primary p-4 transition-colors duration-300">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-soft border border-secondary dark:border-gray-700 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-heading font-bold text-accent mb-2">Recuperar Password</h1>
          <p className="text-muted text-sm">Insira o seu email para receber as instruções.</p>
        </div>
        ...
        {submitted ? (
          <div className="text-center space-y-4">
            ...
            <h3 className="font-bold text-darkText dark:text-lightText">Email Enviado!</h3>
            <p className="text-sm text-muted">
              Se o email <b>{email}</b> estiver registado, receberá um link para redefinir a sua password em breve.
            </p>
